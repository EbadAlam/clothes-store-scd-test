...
<div class="container page">
    ...
    <table id="cart" class="table table-hover table-condensed">
        ...
        <tbody>
            ...
            <td><a href="<?php echo e(route('deletecartitem', $item->id)); ?>" class="btn btn-danger" onclick="return confirm('Are you Sure!')";><i class="fa fa-trash"  ></i></a></td>
        </tr>
...
</html><?php /**PATH /home/kali/Kali/Work/Laravel/cochingtest/resources/views/shopping-cart.blade.php ENDPATH**/ ?>