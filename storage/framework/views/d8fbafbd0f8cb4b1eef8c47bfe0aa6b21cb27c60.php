 ...
 <div class="container-fluid">
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo e($single_product->id); ?></td>
                ...
                <td>
                    <a href="<?php echo e(route('deleteproduct', $single_product->id)); ?>" class="btn btn-danger" onclick="return confirm('Are Your Sure')";>Delete</a>
                </td>
            </tr>               
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kali/Kali/Work/cochingtest/resources/views/admin/product/index.blade.php ENDPATH**/ ?>