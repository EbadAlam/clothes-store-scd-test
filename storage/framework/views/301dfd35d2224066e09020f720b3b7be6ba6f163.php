...
<div class="w3-container w3-text-grey" id="jeans">
  ...
  <div class="w3-row w3-grayscale">
    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
        <?php if($single_product->image): ?>
        <a href=""><img src="<?php echo e(asset($single_product->image)); ?>" alt="" class="img-responsive img-thumbnail" style="width:100%"></a>
        <?php else: ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kali/Kali/Work/Laravel/cochingtest/resources/views/category_detail.blade.php ENDPATH**/ ?>